...
class Partner {
  ...
  static async getInstituitionNameByCourseId(courseId) {
    ...
    return await partnerServices.getInstituitionNameByCourseId(courseIdAsInteger);
  }
  ...
  static async getUsersRegisteredInTheCourseByCourseId(courseId) {
    return await partnerServices.getUsersRegisteredInTheCourseByCourseId(courseId);
  }

  /** Método que deleta um curso selecionado pelo usuário */
  static async deleteCourseByPartnerAndCourseId(userId, courseId) {
    return await partnerServices.deleteCourseByPartnerAndCourseId(userId, courseId);
  }
